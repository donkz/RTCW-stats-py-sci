...
#                        print(x[0])
                    ...
                    if not game_finished and game_started and value.stats:
                        ...
                        # TODO: Redo this whole thing by counting events and then looking them up at round's end
        ...
        try:
            ...
            stats_all = self.populate_guids(stats_all,pb_players, fixed_renames)
