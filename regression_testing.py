...
stat_files.append(r".\test_samples\rtcwconsole-2020-02-06.log") #32
stat_files.append(r".\test_samples\rtcwconsole-2020-02-10.log") #33
...
for read_file in stat_files:
    try:
        processor = FileProcessor(read_file, debug = True)
